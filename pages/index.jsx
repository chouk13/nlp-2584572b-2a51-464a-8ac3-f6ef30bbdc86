...
const PROJECT_NAME = "2584572b-2a51-464a-8ac3-";
...
const IDEA_BRIEF = "Tu es un expert en création de mini-SaaS viraux, ultra rentables, optimisés pour la pub et la scalabilité.\n\nTâche:\n- À partir de la tendance suivante, conçois un mini-SaaS complet.\n\nTendance:\n\"Nom du mini-SaaS : DancePix\nPromesse principale : Transformez instantanément votre photo en vidéo où vous dansez sur les tendances TikTok virales.\nPain point principal : L'utilisateur veut créer rapidement des vidéos captivantes et virales à partir d'une simple image sans prise de vue complexe ni compétences en montage.\nFonctionnalités clés :\n- Génération IA de vidéos dansantes à partir d’une photo uniqu";
